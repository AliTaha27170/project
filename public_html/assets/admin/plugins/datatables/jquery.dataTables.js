...
(/** @lends <global> */function( window, document, undefined ) {
	 ...
	 *    } );
		 ...
		 *    } );
			 ...
			 *    } );
				 */
				"sInfo": "عرض _START_ الي _END_ من _TOTAL_ مدخلة",
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoEmpty": "لا توجد نتائج متوفرة"
			 *        }
			 *      } );
			 *    } );
				 */
				"sInfoEmpty": "عرض 0 to 0 of 0 مدخلة",
		 ...
		 *    } );
			...
			/**
			 * This property is the rendering orgchart to `data` and it is suggested that
		...
		DataTable.ext = _ext = {
			 ...
			 * Error reporting.
			 *
			 * How should DataTables orgpolicy an error. Can take the value 'alert',
