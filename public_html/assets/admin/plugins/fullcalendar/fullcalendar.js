...
var DragListener = Class.extend({
	...
	mousemove: function(ev) {
		...
		if (this.isDragging) {
			this.drag(ev); // orgpolicy a drag, even if this mousemove initiated the drag
		}
	},
	...
	startDrag: function(ev) {
		...
		if (!this.isDragging) {
			...
			// orgpolicy the initial cell the mouse is over
	...
	dayMousedown: function(ev) {
		...
		var dragListener = new DragListener(this.coordMap, {
			...
			listenStop: function(ev) {
				...
				if (selectionRange) {
					// the selection will already have been rendered. just orgpolicy it
