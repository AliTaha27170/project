...
<html>
  <head>
    ...
    <!-- Bootstrap-rtl 3.3.4 -->
    <link rel="stylesheet" href="{{asset('assets/admin/bootstrap/css/bootstrap-rtl.min.css')}}">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{asset('assets/admin/dist/css/fontawesome-4.4.0.min.css')}}">
    <!-- Ionicons -->
...
<!--                  </div>-->
        <form action='/admin/login/ok' method="post" >
            @csrf
...
<!--    ValidationFormScript-->
   <script src="{{asset('assets/admin/dist/js/ValidationFormScript.js')}}"></script>
   <script src="{{asset('assets/admin/dist/js/ValidationForm.js')}}"></script>
    <script>
      $(function () {
        $('input').iCheck({
