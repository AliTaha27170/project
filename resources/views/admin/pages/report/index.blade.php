                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    ...
                                    <a href="/admin/report/create" class="btn btn-primary pull-left"><i
                                            ...
                                            @foreach ($reports as $report)
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%" align="center">
                                                        <a href="/admin/report/delete/{{$report->id}}" onclick="return confirm('هل انت متاكد')" type="button" class="btn btn-danger">حذف</a>
