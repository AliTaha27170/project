            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> اضافة مخطط هيكلي <small>جديد</small> </h3>
                        <i class="pull-left header fa fa-th"></i>
                    </div><!-- /.box-header -->

                    <form role="form" id="signupForm1" action="{{ route('orgchart.store') }}" onsubmit="return check()"
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">صورة المخطط الهيكلي :</label>
                                                            <div class="col-sm-9">
                                                        <div class="file-upload">
                                                            ...
                                                            <div class="image-upload-wrap">
                                                                ...
                                                                @enderror
                                                                <div class="drag-text">
                                                                    <h3>إضافة صورة للمخطط الهيكلي </h3>
                                                                </div>
                                                            </div>
