            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> تعديل جدول الأعمال  </h3>
                        <i class="pull-left header fa fa-th"></i>
                    </div><!-- /.box-header -->

                    <form role="form" id="signupForm1" action="{{ route('workschedule.update' , $workschedule->id) }}" onsubmit="return check()"
                                                ...
                                                <div class="col-md-8">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">عنوان جدول الأعمال :</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" name="title"
                                                                       value="{{ old('title' , $workschedule->title) }}" placeholder=""
                                                                       data-fv-field="">
                                                                @error('title')
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">جدول الأعمال:</label>
                                                            <div class="col-sm-9">
                                                        <div class="file-upload">
                                                            ...
                                                            <div class="image-upload-wrap">
                                                                <input class="file-upload-input" type='file' name="image"
                                                                    ...
                                                                    @if($workschedule->image)<img src="{{ asset('storage/' . $workschedule->image) }}" width="100%">@endif
                                                                    @error('image')
                                                                    <p class="text-danger">{{ $message }}</p>
                                                                @enderror
                                                                <div class="drag-text">
                                                                    <h3>إضافة صورة لجدول الأعمال </h3>
                                                                </div>
                                                            </div>
