        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="signupForm1" action="{{ route('news.update' , $news->id) }}" onsubmit="return check()"
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">عنوان الخبر :</label>
                                                            <div class="col-sm-9">
                                                                <textarea type="text" class="form-control" name="title"
                                                                    value="" placeholder=""
                                                                    data-fv-field="">{{ old('title' , $news->title) }}</textarea>
                                                                @error('title')
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea type="text" class="form-control" name="mini_des"
                                                                    value="}" placeholder=""
                                                                    data-fv-field="">{{$news->mini_des}}</textarea>
                                                                @error('mini_des')
                                                                    <p class="text-danger">{{ $message }}</p>
                                                                @enderror
                                                            </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">تفاصيل الخبر : </label>
                                                            <div class="col-sm-9">
                                                                <textarea name="description"
                                                                    value="" id="" cols="30"
                                                                    rows="20">{{old('description' , $news->description)}}</textarea>
                                                                @error('description')
                                                                    <p class="text-danger">{{ $message }}</p>
                                                                @enderror
                                                            </div>
                                                    ...
                                                    <div class="file-upload">
                                                        ...
                                                        <div class="image-upload-wrap">
                                                            <input class="file-upload-input"  type='file' name="image"
                                                                ...
                                                                @if($news->image)<img src="{{ asset('storage/' . $news->image) }}" width="100%">@endif
                                                                @error('image')
                                                                <p class="text-danger">{{ $message }}</p>
                                                            @enderror
                                                            <div class="drag-text">
                                                                <h3>إضافة صور للخبر </h3>
                                                            </div>
                                                        </div>
