            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> اضافة خبر <small>جديد</small> </h3>
                        <i class="pull-left header fa fa-th"></i>
                    </div><!-- /.box-header -->

                    <form role="form" id="signupForm1" action="{{ route('news.store') }}" onsubmit="return check()"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea type="text" class="form-control" name="title"
                                                                    value="" placeholder=""
                                                                    data-fv-field="">{{ old('title') }}</textarea>
                                                                @error('title')
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea type="text" class="form-control" name="mini_des"
                                                                    value="" placeholder=""
                                                                    data-fv-field="">{{ old('mini_des') }}</textarea>
                                                                @error('mini_des')
                                                                    <p class="text-danger">{{ $message }}</p>
                                                                @enderror
                                                            </div>
