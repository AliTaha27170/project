            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> تعديل الشريك  </h3>
                        <i class="pull-left header fa fa-th"></i>
                    </div><!-- /.box-header -->

                    <form role="form" id="signupForm1" action="{{ route('supporter.update' , $supporter->id) }}" onsubmit="return check()"
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label"> اسم الداعم :</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" name="name"
                                                                    value="{{ old('title' , $supporter->name) }}" placeholder=""
                                                                    data-fv-field="">
                                                                @error('name')
                                                    ...
                                                    <div class="file-upload">
                                                        ...
                                                        <div class="image-upload-wrap">
                                                            <input class="file-upload-input"  type='file' name="image"
                                                                ...
                                                                @if($supporter->image)<img src="{{ asset('storage/' . $supporter->image) }}" width="100%">@endif
                                                                @error('image')
                                                                <p class="text-danger">{{ $message }}</p>
                                                            @enderror
                                                            <div class="drag-text">
                                                                <h3>إضافة صورة  للداعم </h3>
                                                            </div>
                                                        </div>
