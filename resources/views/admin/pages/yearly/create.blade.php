    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="/admin/yearly-report/index">قائمة التقارير السنوية</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"> اضافة تقرير سنوي <small>جديد</small> </h3>
                            <i class="pull-left header fa fa-th"></i>
                        </div><!-- /.box-header -->
                        <!-- form start -->

                        <form role="form" id="addOfferForm" method="post" action="/admin/yearly-report/store"
                            ...
                            <div class="box-body col-md-12">
                                <div class="col-md-8">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">ملف  تقرير مالي :</label>
                                            <div class="col-sm-9">
