            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> تعديل المبادرة  </h3>
                        <i class="pull-left header fa fa-th"></i>
                    </div><!-- /.box-header -->

                    <form role="form" id="signupForm1" action="{{ route('initiative.update' , $init->id) }}" onsubmit="return check()"
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">عنوان المبادرة :</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" name="title"
                                                                    value="{{ old('title' , $init->title) }}" placeholder=""
                                                                    data-fv-field="">
                                                                @error('title')
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label"> تفصيل مختصر :</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" name="mini_des"
                                                                    value="{{$init->mini_des}}" placeholder=""
                                                                    data-fv-field="">
                                                                @error('mini_des')
                                                                    <p class="text-danger">{{ $message }}</p>
                                                                @enderror
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">تفاصيل المبادرة : </label>
                                                            <div class="col-sm-9">
                                                                <textarea name="description"
                                                                    value="" id="" cols="30"
                                                                    rows="20">{{old('description' , $init->description)}}</textarea>
                                                                @error('description')
                                                                    <p class="text-danger">{{ $message }}</p>
                                                                @enderror
                                                            </div>
                                                    ...
                                                    <div class="file-upload">
                                                        ...
                                                        <div class="image-upload-wrap">
                                                            <input class="file-upload-input"  type='file' name="image"
                                                                ...
                                                                @if($init->image)<img src="{{ asset('storage/' . $init->image) }}" width="100%">@endif
                                                                @error('image')
                                                                <p class="text-danger">{{ $message }}</p>
                                                            @enderror
                                                            <div class="drag-text">
                                                                <h3>إضافة صور للمبادرة </h3>
                                                            </div>
                                                        </div>
