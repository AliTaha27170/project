    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="/admin/admin">قائمة المدراء</a></li>
                <li class="active">اضافة مدير جديد</li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"> اضافة مدير <small>جديد</small> </h3>
                            <i class="pull-left header fa fa-th"></i>
                        </div><!-- /.box-header -->
                        <!-- form start -->

                        <form role="form" id="addOfferForm" method="post" action="{{ route('admin.update',$admin->id) }}"
                                ...
                                <div class="col-md-8">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">اسم المدير :</label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">ايميل المدير</label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">كلمة السر</label>
                                            <div class="col-sm-9">
                                                <input type="password" class="form-control" name="password" placeholder="اترك الحقل فارغا" >
                                            </div>
                                        </div>
