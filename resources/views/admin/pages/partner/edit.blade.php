        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="signupForm1" action="{{ route('partner.update' , $partner->id) }}" onsubmit="return check()"
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label"> اسم الشريك :</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" name="name"
                                                                    value="{{ old('title' , $partner->name) }}" placeholder=""
                                                                    data-fv-field="">
                                                                @error('name')
                                                    ...
                                                    <div class="file-upload">
                                                        ...
                                                        <div class="image-upload-wrap">
                                                            <input class="file-upload-input"  type='file' name="image"
                                                                ...
                                                                @if($partner->image)<img src="{{ asset('storage/' . $partner->image) }}" width="100%">@endif
                                                                @error('image')
                                                                <p class="text-danger">{{ $message }}</p>
                                                            @enderror
                                                            <div class="drag-text">
