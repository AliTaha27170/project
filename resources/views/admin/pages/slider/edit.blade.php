            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> تعديل سلايدر  </h3>
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea class="form-control" value="" type="text" name="title" id="">{{$slide->title}}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                                <label class="col-sm-3 control-label"> وصف السلايد :</label>
                                                            <div class="col-sm-9">
                                                                <textarea class="form-control" value="" type="text" name="description" id="">{{$slide->description}}</textarea>
                                                            </div>
                                                        </div>
