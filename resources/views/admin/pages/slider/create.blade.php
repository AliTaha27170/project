            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> اضافة سلايدر <small>جديد</small> </h3>
                        <i class="pull-left header fa fa-th"></i>
                    </div><!-- /.box-header -->

                    <form role="form" id="signupForm1" action="{{ route('slider.store') }}" onsubmit="return check()"
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label"> صورة السلايد :</label>
                                                            <div class="col-sm-9">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                                <label class="col-sm-3 control-label"> عنوان السلايد :</label>
                                                            <div class="col-sm-9">
                                                                <textarea class="form-control" type="text" name="title" id=""></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                                <label class="col-sm-3 control-label"> وصف السلايد :</label>
                                                            <div class="col-sm-9">
                                                                <textarea class="form-control" type="text" name="description" id=""></textarea>
                                                            </div>
                                                        </div>
