    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{route('goal-main.index')}}">قائمة الأهداف</a></li>
                <li class="active">اضافة هدف جديد</li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"> اضافة هدف <small>جديد</small> </h3>
                            <i class="pull-left header fa fa-th"></i>
                        </div><!-- /.box-header -->
                        <!-- form start -->

                        <form role="form" id="addOfferForm" method="post" action="{{ route('goal-main.update',$goal->id) }}"
                                ...
                                <div class="col-md-8">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label"> عنوان الهدف :</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" value="{{$goal->title}}" name="title" placeholder=""
                                                    data-fv-field="" value="">
                                                @error('title')
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label"> تفاصيل الهدف</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" value="{{$goal->description}}" name="description" >
                                                @error('description')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
