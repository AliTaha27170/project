        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="signupForm1" action="{{ route('actmain.update' , $actmain->id) }}" onsubmit="return check()"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" name="title"
                                                                    value="{{ old('title' , $actmain->title) }}" placeholder=""
                                                                    data-fv-field="">
                                                                @error('title')
                                                    ...
                                                    <div class="file-upload">
                                                        ...
                                                        <div class="image-upload-wrap">
                                                            <input class="file-upload-input"  type='file' name="image"
                                                                ...
                                                                @if($actmain->image)<img src="{{ asset('storage/' . $actmain->image) }}" width="100%">@endif
                                                                @error('image')
                                                                <p class="text-danger">{{ $message }}</p>
                                                            @enderror
                                                            <div class="drag-text">
